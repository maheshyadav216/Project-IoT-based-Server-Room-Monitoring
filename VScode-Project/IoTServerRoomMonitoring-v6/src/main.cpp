...
#define BOTtoken "xxxxxxxxx:xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" // your Bot Token (Get from Botfather)
String Mychat_id = "xxxxxxxxxxx";
...
int fire_sensor_pin = 6;           // you can use 7 buzzer pin or 6 INT pin, just change their definition at Arduino_MKRIoTCarrier.h
